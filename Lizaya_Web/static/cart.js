...
function addItemToCart(title, price, imageSrc) {
    ...
    var cartRowContents = `
        <div class="cart-item cart-column">
            <img class="cart-item-image" src="${imageSrc}" width="120px" height="100px">
...
function required(){
var empt=document.form1.firstName.secondName.country.email.phoneNumber.mpesa.visabtn.value;
     if( empt ===""){
...
var modal=document.getElementById('id01');
  ...
  var modal=document.getElementById('id03');
     ...
     var undisputed=document.getElementById('josh');
                        window.onclick=function(event){
                        if(event.target==undisputed){
                        undisputed.style.display="none";
                        }}
function mySearch(){
